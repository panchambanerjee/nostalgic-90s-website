                ...
                <tr>
                    <td>
                        ...
                        <p><font face="Arial" size="3">
                            <b>Real Name:</b> Tom from MySpace<br>
                            <b>Age:</b> 16<br>
        ...
        if (mainContentArea) {
            ...
            switch(pageName) {
                ...
                case 'guestbook':
                    ...
                    break;
                case 'downloads':
                    pageContent = getDownloadsContentDirect();
                    break;
                case 'chat':
...
function getPhotosContentDirect() {
    return window.ExtendedNavContent ? ExtendedNavContent.getPhotosContent() : '<center><h1>Photos Loading...</h1></center>';
}
...
function getDownloadsContentDirect() {
    return window.ExtendedNavContent ? ExtendedNavContent.getDownloadsContent() : '<center><h1>Downloads Loading...</h1></center>';
}
